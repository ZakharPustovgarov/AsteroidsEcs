...
public class ShowNHideMoveObject : ShowNHide
{
    [SerializeField]
    List<Transform> _up;
    [SerializeField]
    List<Transform> _down;
    [SerializeField]
    List<Transform> _left;
    [SerializeField]
    List<Transform> _right;
    ...
    public override float Hide(bool isMomentum = false)
    {
        ...
        {
            if (_movingRoutine == null) _movingRoutine = StartCoroutine(Hiding());
    ...
    public override float Show(bool isMomentum = false)
    {
        ...
        {
            if (_movingRoutine == null) _movingRoutine = StartCoroutine(Showing());
